        ...
        <div className="container">
            <div className="terminal-section">
                <div className="img-side">
                    <ImageWithText>
                        hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for
                        test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi,
                        for test. hi, for test. hi, for test. hi, for test. hi, for test.
                        hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for
                        test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi,
                        for test. hi, for test. hi, for test. hi, for test. hi, for test.
                        hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for
            ...
            <div className="terminal-section">
                <div className="bottom-images">
                    <ImageWithText>
                        hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for
                        test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test. hi, for test.
